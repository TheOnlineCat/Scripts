...
local ShopsFolder = workspace.World:FindFirstChild("Shop")
    ...
    function BossFarmStrategy:FindAvailableNPC()
        for _, folder in {NPCsFolder, HiddenNPCsFolder} do
            for _, boss in folder:GetChildren() do
                ...
                if not boss:GetAttribute("Cooldown") and not boss:GetAttribute("LossCooldown") and not boss:GetAttribute("LossCooldown") then continue end
